  ...
  <div class="six-draw" v-if="prizeList">
    <div class="box" ref="box">
      ...
      <div class="prize-wrap">
        <img class="prize-item" v-for="prize in prizeArr"
             :src="imgPrefix(prize)"
             :style="{transformOrigin:transformOrigin}"
             @click.stop="goPrizeIfo(prize)"
        />
      </div>
      <img src="../../assets/img/draw/sg.png" class="sg" v-show="!beginFlag"/>
      <img src="../../assets/img/draw/闪灯1.gif" class="sg" v-show="beginFlag"/>
      <div class="pointer"
...
<script>
  ...
  import bg from '../../assets/img/draw/dzp.png'
  export default{
    props: {
      prizeList: {
        type: Array,
    ...
    computed: {
      prizeArr(){
        ...
        return Util.fillArr(this.prizeList, 8, item)
      }
    },
    data(){
      return {
    ...
    methods: {
      ...
      begin(id){
        ...
        this.pointerRotate = `rotate(${3600 * this.drawNumber + 45 * activeIndex}deg)`
      },
      end(){
