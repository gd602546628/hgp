  ...
  <zyt-page :hasHeader="false" :hasFooter="true">
    <div slot="main" class="scratchCardClass">
      <div class="concent" v-if="drawActivitydDetail">
        ...
        <!--中奖纪录和奖品轮播-->
        <drawSilde :drawActivitydDetail="drawActivitydDetail" :isSixSty="true"></drawSilde>
        ...
        <div class="twelve-draw-box">
          <sixDraw :prizeList="drawActivitydDetail.drawSalesPrizeList"
        ...
        <!--活动说明-->
        <drawDesc :drawActivitydDetail="drawActivitydDetail" :isSixSty="true"></drawDesc>
    ...
    methods: {
      ...
      async pointerClick() {
        ...
        if (data.code === '400013') { // 没有次数
          ...
          this.$refs.six.begin(-1)
          this.drawNum--
        } else {  // 中奖
          this.drawNum--
          this.$refs.six.begin(data.data.drawSalesPrize.id)
        }
      },
      end() {
        this.disabled = false
    ...
    .row {
      ...
      .col {
        ...
        .firstP {
          ...
          margin-right: 10px;
          color: #b54a07;
          border: 1px solid #8a1ccb;
          background: -webkit-linear-gradient(top, #f5db32, #e8b005);
        }
        .lastP {
          margin-right: 10px;
          margin-left: 10px;
          border: 1px solid #3c0678;
          background: -webkit-linear-gradient(top, #9e1ed9, #57109c);
        }
      }
    }
  }
