  ...
  <form id="password-form" class="login-form" onsubmit="javascript:return false">
    ...
    <mt-field  label="验证码" type="number" :attr="{ maxlength: 6}" placeholder="验证码" v-model="data.smsCode">
      <div class="msg-container">
        <countdown-component  ref="countdown" storage-key="changePassword-countdown" class="sms-btn" @click="getSmsMsg"
    ...
    <mt-field label="新密码" :type="password" :attr="{ maxlength: 20}" placeholder="请输入密码" v-model="data.password">
    ...
    <div class="line line-padding">
      <button type="submit" class="btn" @click="submit()">完成</button>
    </div>
  </form>
  </div>
</zyt-page>
