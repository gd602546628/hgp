<template>
  <zyt-page :hasFooter="true">
      ...
      <div class="cvnPrdDtl-addbox" v-if="coupon.companyInfo">
        <div class="cvnPrdDtl-navigation" @click.prevent="navigation(coupon.companyInfo)">
          <div class="cvnPrdDtl-input">
            {{ coupon.companyInfo.provinceName + coupon.companyInfo.cityName + coupon.companyInfo.districtName + coupon.companyInfo.address
            }}
          </div>
        </div>
    ...
    <!-- <div slot="footer" class="footer">
       <button @click.stop="openShareModal()">赠送给好友</button>
       <mt-popup class="share-popup" v-model="showShare" position="bottom">
         <div class="popup-wrap">
           <div class="share-item" @click.stop="doShare">
    ...
    methods: {
      ...
      async getUserCouponInfo(){ // 获取优惠码
        ...
        if (document.getElementById('coupon-QRCode')) {
          ...
          console.log(this.couponCode, type)
        }
      },
      async getLocation(){
