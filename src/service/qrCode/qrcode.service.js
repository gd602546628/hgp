  ...
  !function () {
    ...
    i.prototype = {
      ...
      mod: function (a) {
        ...
        for (var b = g.glog(this.get(0)) - g.glog(a.get(0)), c = new Array(this.getLength()),
               d = 0; d < this.getLength(); d++) c[d] = this.get(d);
    ...
    var l = [
      ...
      q = p ? o : m() ? function () {
        ...
        if (/*this._android && this._android <= 2.1*/ n() && n() <= 2.1) {
        ...
        return a.prototype.draw = function (a) {
          for (var b = this._htOption, c = this._el, d = a.getModuleCount(), e = Math.floor(b.width / d),
                 f = Math.floor(b.height / d), g = ['<table style="border:0;border-collapse:collapse;">'],
                 h = 0; d > h; h++) {
            g.push('<tr>')
